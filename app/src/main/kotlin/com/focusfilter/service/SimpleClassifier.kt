...
class SimpleClassifier : NotificationClassifier {
    ...
    override fun classify(notificationText: String): String {
        ...
        return when {
            ...
            lower.containsAny(
                "offer", "discount", "sale", "% off", "deal",
                "limited time", "coupon", "promo", "cashback", "rewards"
            ) -> "promo"
            ...
            lower.containsAny(
                "meeting", "call scheduled", "reminder", "task",
                "due", "deadline", "assigned", "project",
                "interview", "appointment", "booking confirmed",
                "reservation confirmed", "check-in", "flight"
            ) -> "important"
