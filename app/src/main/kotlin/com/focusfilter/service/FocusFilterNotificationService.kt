...
class FocusFilterNotificationService : NotificationListenerService() {
    ...
    private val lastProcessedKey = java.util.concurrent.atomic.AtomicReference<String?>(null)
    ...
    override fun onNotificationPosted(sbn: StatusBarNotification) {
        ...
        val prevKey = lastProcessedKey.getAndSet(sbn.key)
        if (prevKey == sbn.key) return
